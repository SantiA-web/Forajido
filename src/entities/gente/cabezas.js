/**
 * LA GENTE, PARTE 2: las cabezas.
 *
 * Están dibujadas a 15 filas (de la 12 a la 27), que es lo que mide la cabeza
 * con las piernas largas. Achicarlas deformándolas borraba filas: el ala del
 * sombrero tapaba los ojos y bigote, boca y mentón quedaban pegados. Cejas y
 * ojos quedaron donde estaban (filas 15 a 19); lo que se acomodó es de la nariz
 * para abajo.
 */
import {
  ROPA, tono, corrido, cejasYOjos,
  NEGRO, OJO_B, PIEL, PIEL_S, PIEL_O, PIEL_L, PELO, BIGOTE,
} from './dibujo.js';

export function cabezaFrente(L, o, g = 0) {
...
export function cabezaEspalda(L, o, g = 0) {
  const R = ROPA[o.tipo];
...
export function cabezaLado(L, o) {
  const R = ROPA[o.tipo];
  ...
  if (alerta) { L.rect(25, 15, 2, 1, PELO); L.rect(27, 16, 3, 1, PELO); L.rect(27, 18, 2, 1, OJO_B); L.rect(28, 18, 1, 1, NEGRO); }
    ...
    L.rect(27, 17, 2, 2, OJO_B); L.rect(28, 17, 1, 2, o.estado === 'aturdido' ? '#6a6258' : NEGRO);
  }
