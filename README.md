...
- **El revólver te sigue el mouse todo el tiempo**: el brazo apunta a donde
  mirás aunque el caballo siga derecho, para adelante, para los costados o
  para atrás. Gira el brazo, no el cuerpo.
...
- Antes de tirar, cada jinete **avisa con el arma**: se frena y **se lleva el
  rifle a la cara**, encarándote, agachándose detrás. El arma pasa de las
